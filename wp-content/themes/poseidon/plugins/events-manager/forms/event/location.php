...
<div id="em-location-data" class="em-location-data">
	...
	<table class="em-location-data">
		...
		<tr class="em-location-data-address">
			<th><?php _e ( 'Address line 1:', 'events-manager')?>&nbsp;</th>
			<td>
		...
		<tr class="em-location-data-town">
			<th><?php _e ( 'Address line 2:', 'events-manager')?>&nbsp;</th>
			<td>
				<input id="location-town" type="text" name="location_town" 
					value="<?php 
						if (esc_attr($EM_Location->location_town) !== '') {
							echo esc_attr($EM_Location->location_town);
						} else {
							echo 'Waltham Forest';
						}
					?>" /><?php echo $required; ?>
		...
		<tr class="em-location-data-postcode">
			...
			<td>
				<input id="location-postcode" type="text" name="location_postcode" value="<?php echo esc_attr($EM_Location->location_postcode); ?>" /><?php echo $required; ?>
			</td>
		</tr>
